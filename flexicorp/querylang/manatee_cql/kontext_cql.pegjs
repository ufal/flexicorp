 ...
 *
 * Copied and adapted from Kontext's scripts/build/cql.pegjs so flexicorp can
 * validate and highlight Manatee CQL locally.
 *
 * Original note from Kontext:
 * This is a PEG version of an original CQL grammar (except for the regular
 * expression grammar) distributed with manatee-open corpus search engine.
 *
